...
def build_dataset(args, split, download=True):
    ...
    if dataset_name == 'celeba': 
        ...
        transform = {
            'train': tfs.Compose([tfs.CenterCrop((178, 178)),
                                       tfs.Resize((128, 128)),
                                       #tfs.Grayscale(),                                       
                                       #tfs.Lambda(lambda x: x/255.),
                                       tfs.ToTensor()]),
            'valid': tfs.Compose([tfs.CenterCrop((178, 178)),
                                       tfs.Resize((128, 128)),
                                       #tfs.Grayscale(),                                       
                                       #tfs.Lambda(lambda x: x/255.),
                                       tfs.ToTensor()]),
        ...
        def att_select(tensor):
            third_value = tensor[20]
            return int(third_value)
