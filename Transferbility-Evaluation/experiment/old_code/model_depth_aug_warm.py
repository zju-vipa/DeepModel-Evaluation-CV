...
def main(args):
    ...
    # tr_optimizer = optim.SGD(model.parameters(), lr=0.01, momentum=0.9, weight_decay=5e-4)
    # tr_train_scheduler = optim.lr_scheduler.StepLR(tr_optimizer, 20, gamma=0.2)
    ...
    #     if not epoch % settings.TR_SAVE_EPOCH:
    #         torch.save(model.state_dict(), checkpoint_path.format(arch=args.arch, epoch=epoch, type='regular'))
