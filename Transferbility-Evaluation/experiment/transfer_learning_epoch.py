...
parser.add_argument('--end_epoch', type=str, default=20)
...
def transfer_learning(args):
    ...
    #获取数据集和dataloader
    train_loader, test_loader = get_dataset_and_loader(args, class_num=class_num, sample_num=sample_num)
    start_epoch = 1
    ...
    # 余弦退火学习率
    train_scheduler = optim.lr_scheduler.CosineAnnealingLR(optimizer,T_max=args.end_epoch)
    # StepLR
